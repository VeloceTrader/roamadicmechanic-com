const CACHE_NAME = 'roamadic-oil-change-v1';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
  '/icons/oil-change/icon-192.png',
  '/icons/oil-change/icon-512.png',
  '/icons/oil-change/icon-192-maskable.png',
  '/icons/oil-change/icon-512-maskable.png',
  '/icons/oil-change/apple-touch-icon.png'
];
