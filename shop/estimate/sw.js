const CACHE_NAME = 'roamadic-estimate-v1';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
  '/icons/estimate/icon-192.png',
  '/icons/estimate/icon-512.png',
  '/icons/estimate/icon-192-maskable.png',
  '/icons/estimate/icon-512-maskable.png',
  '/icons/estimate/apple-touch-icon.png'
];
