const CACHE_NAME = 'roamadic-invoice-v1';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
  '/icons/invoice/icon-192.png',
  '/icons/invoice/icon-512.png',
  '/icons/invoice/icon-192-maskable.png',
  '/icons/invoice/icon-512-maskable.png',
  '/icons/invoice/apple-touch-icon.png'
];
